...
# Initialize Trainer with checkpoint resume functionality
trainer = Trainer(
    model=model,
    args=training_args,
...
# Check if there is a checkpoint available to resume from
checkpoint = None
checkpoint_dir = "./results/checkpoint-123"  # Path to your checkpoint folder
